...
export default function Dashboard() {
  return (
    <div className="m-10">
      ...
      <span className="text text-gray-600">Essas são as últimas atividades recentes do hotel</span>
      ...
      <section className="flex items-center gap-10 mt-32">
        <Line className="border p-4 rounded max-h-[300px] max-w-[1000px]" options={options} data={data} />
        <Card className="h-[300px]">
          <h1 className="text-2xl font-bold">Alguma outra informação</h1>
          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Temporibus dolorum ad ex magnam alias rerum beatae delectus consequatur vero earum? Hic voluptate doloremque eligendi esse beatae veniam nesciunt laborum nam?</p>          
        </Card>
      </section>
    </div>
  );
